...
CREATE TABLE `order` (
  ...
  KEY `orders_to_buyer` (`buyer_id`),
  CONSTRAINT `order_status` FOREIGN KEY (`status`) REFERENCES `order_statuses` (`order_status`),
  CONSTRAINT `orders_to_buyer` FOREIGN KEY (`buyer_id`) REFERENCES `buyer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
